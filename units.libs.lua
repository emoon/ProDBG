...
StaticLibrary {
    ...
    Sources = {
        ...
        -- Uncomment this if you need to build/re-generate the shaders. These then needs to be copied
        ...
        -- autogenerated files
        ApiGen { Source = "src/tools/api_gen/pd_ui.json", Lang="-cpp", OutName = "api/include/pd_ui_autogen.h", LangCfg="src/tools/api_gen/cpp.json" },
        ApiGen { Source = "src/tools/api_gen/pd_ui.json", Lang="-rs",  OutName = "api/rust/prodbg/src/ui_ffi_autogen.rs", LangCfg="src/tools/api_gen/rust.json" },
    },
