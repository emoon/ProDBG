...
class IBackendRequests : public QObject {
   ...
   public:
    ...
    virtual void beginAddFileLineBreakpoint(const QString& filename,
                                            int line) = 0;
    ...
    virtual void beginRemoveFileLineBreakpoint(const QString& filename,
                                               int line) = 0;
    ...
    virtual void beginResolveAddress(const QString& expression,
                                     uint64_t* out) = 0;
    ...
    virtual bool beginReadMemory(uint64_t lo,
                                 uint64_t hi,
                                 QVector<uint16_t>* target) = 0;
   ...
   public:
    ...
    Q_SIGNAL void endReadMemory(QVector<uint16_t>* target,
                                uint64_t address,
                                int addressWidth);
