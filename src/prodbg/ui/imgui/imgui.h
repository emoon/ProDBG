...
public:
    ...
    inline iterator             erase(const_iterator it)        { IM_ASSERT(it >= begin() && it < end()); const int off = (int)(it - begin()); memmove(Data + off, Data + off + 1, (Size - (size_t)off - 1) * sizeof(value_type)); Size--; return Data + off; }
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
bool        BeginWithWindow(struct ImGuiWindow* window, const char* name, bool* open = NULL, ImVec2 size = ImVec2(0, 0), float fill_alpha = -1.0f, ImGuiWindowFlags flags = 0);
void        End();
