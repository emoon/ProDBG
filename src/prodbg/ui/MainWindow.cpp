...
void MainWindow::onMenu(int id)
{
	...
	switch (id)
	{
		...
		case MENU_DEBUG_GO : Session_action(m_activeSession, PDAction_run); break; 
		case MENU_DEBUG_STOP : Session_action(m_activeSession, PDAction_break); break; 
		case MENU_DEBUG_STEP : Session_action(m_activeSession, PDAction_step); break; 
		case MENU_DEBUG_STEP_OVER : Session_action(m_activeSession, PDAction_stepOver); break; 
		case MENU_DEBUG_STEP_OUT : Session_action(m_activeSession, PDAction_stepOut); break; 
...
void MainWindow::onAttachRemote()
{
	if (m_remoteSession)
		return;
...
void MainWindow::tick()
{
	...
	Session_update(m_activeSession);
}
