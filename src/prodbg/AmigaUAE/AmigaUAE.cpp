...
{
    QString fileDest = QDir::cleanPath(destPath + QDir::separator() + QStringLiteral("uae_config.fs-uae"));

    QFile file(fileDest);
    if (!file.open(QIODevice::WriteOnly | QIODevice::Text)) {
        QMessageBox::critical(nullptr, QStringLiteral("Unable to write config to temp directory"),
                              fileDest);
        return QString();
    }
