...
void* create_instance(ServiceFunc* serviceFunc) {
    ...
    int reg_counter = 0;
    fill_register(&plugin->registers[reg_counter++], "eax", 4, (unsigned char[]){0xCA, 0xCB, 0xCC, 0xCD}, 0);
    fill_register(&plugin->registers[reg_counter++], "ebx", 4, (unsigned char[]){0x7E, 0xFD, 0xE0, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "ecx", 4, (unsigned char[]){0x00, 0x01, 0x21, 0x21}, 0);
    fill_register(&plugin->registers[reg_counter++], "edx", 4, (unsigned char[]){0x00, 0xD0, 0x95, 0x80}, 0);
    fill_register(&plugin->registers[reg_counter++], "esi", 4, (unsigned char[]){0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "edi", 4, (unsigned char[]){0x00, 0x39, 0xFA, 0x28}, 0);
    fill_register(&plugin->registers[reg_counter++], "eip", 4, (unsigned char[]){0x00, 0xD0, 0x17, 0xAE}, 0);
    fill_register(&plugin->registers[reg_counter++], "esp", 4, (unsigned char[]){0x00, 0x39, 0xF9, 0x5C}, 0);
    fill_register(&plugin->registers[reg_counter++], "ebp", 4, (unsigned char[]){0x00, 0x39, 0xFA, 0x28}, 0);
    fill_register(&plugin->registers[reg_counter++], "efl", 4, (unsigned char[]){0x00, 0x00, 0x02, 0x00}, 1);

    fill_register(&plugin->registers[reg_counter++], "cs", 2, (unsigned char[]){0x00, 0x23}, 0);
    fill_register(&plugin->registers[reg_counter++], "ds", 2, (unsigned char[]){0x00, 0x2B}, 0);
    fill_register(&plugin->registers[reg_counter++], "es", 2, (unsigned char[]){0x00, 0x2B}, 0);
    fill_register(&plugin->registers[reg_counter++], "ss", 2, (unsigned char[]){0x00, 0x2B}, 0);
    fill_register(&plugin->registers[reg_counter++], "fs", 2, (unsigned char[]){0x00, 0x53}, 0);
    fill_register(&plugin->registers[reg_counter++], "gs", 2, (unsigned char[]){0x00, 0x2B}, 0);

    fill_register(&plugin->registers[reg_counter++], "st0", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st1", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st2", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st3", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st4", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st5", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st6", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "st7", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "ctrl", 2, (unsigned char[]){0x02, 0x7F}, 0);
    fill_register(&plugin->registers[reg_counter++], "stat", 2, (unsigned char[]){0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "tags", 2, (unsigned char[]){0xFF, 0xFF}, 0);
    fill_register(&plugin->registers[reg_counter++], "edo", 4, (unsigned char[]){0x00, 0x00, 0x00, 0x00}, 0);

    fill_register(&plugin->registers[reg_counter++], "mm0", 8, (unsigned char[]){0xB1, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x9A}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm1", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm2", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm3", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm4", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm5", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm6", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mm7", 8, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);

    fill_register(&plugin->registers[reg_counter++], "xmm0", 16, (unsigned char[]){0x40, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x51, 0x51, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm1", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm2", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm3", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm4", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm5", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm6", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "xmm7", 16, (unsigned char[]){0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, 0);
    fill_register(&plugin->registers[reg_counter++], "mxcsr", 4, (unsigned char[]){0x00, 0x00, 0x1F, 0x80}, 0);
